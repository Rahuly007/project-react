...
export const Navbar = (props) => {
    ...
    if (email == undefined) {
        var button = <Link to="/login" className="nav-item nav-link">Login</Link>
    } else {
        var button = <button className='btn btn' onClick={Logout}>Logout</button>
    }
    return (
        <React.Fragment>
            {/* <!-- Navbar Start --> */}
                        ...
                        <nav className="collapse show navbar navbar-vertical navbar-light align-items-start p-0 border border-top-0 border-bottom-0" id="navbar-vertical">
                            <div className="navbar-nav w-100 overflow-hidden" style={{ height: "410px" }}>
                                ...
                                </div> */}
                                {
                                    products.map((item) => {
                                        return (
                                            <a href="" className="nav-item nav-link">{item.ProductName}</a>
                                        )
                                    })
                                }
                    ...
                    <div className="col-lg-9">
                        ...
                        <div id="header-carousel" className="carousel slide" data-ride="carousel">
                            <div className="carousel-inner">
                                ...
                                <div className="carousel-item" style={{ height: "410px" }}>
                                    <img className="img-fluid" src="assets/img/carousel-4.jpg" alt="Image" />
                                    <div className="carousel-caption d-flex flex-column align-items-center justify-content-center">
                                        <div className="p-3" style={{ maxWidth: "700px" }}>
                                            {/* <h4 className="text-light text-uppercase font-weight-medium mb-3">10% Off Your First Order</h4> */}
                                            {/* <h3 className="display-4 text-white font-weight-semi-bold mb-4">Reasonable Price</h3> */}
